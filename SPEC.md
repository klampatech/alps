...
6. **Cost ceiling** — "brute force" + LLM Judge = real money on a multi-reject cycle. Add a per-task USD cap that exits with `AlpsError` if exceeded.
